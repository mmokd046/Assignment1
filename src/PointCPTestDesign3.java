...
public class PointCPTestDesign3
{
  ...
  public static void main(String[] args)
  {
    ...
    System.out.println("Design 3 UI test");
    ...
    System.out.println("\nThe cartesian coordinate of the point that you input are :\n" + point);
    PointCPDesign2 polarPoint =  point.convertStorageToPolar();
    System.out.println("\nAfter asking to convert  the cartesian coordinate into polar coordinate :\n" + polarPoint);
    double minimumValue = 100;
    double maximumValue = 100000;
    TestPointCPDesign3Performance(minimumValue,maximumValue);  
    }
  ...
  // Add function that test the time and return the value in the main method
  private static void TestPointCPDesign3Performance (double minimumValue, double maximumValue) {
